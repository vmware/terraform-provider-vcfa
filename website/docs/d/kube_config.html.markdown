---
layout: "vcfa"
page_title: "VMware Cloud Foundation Automation: vcfa_kube_config"
sidebar_current: "docs-data-source-vcfa-kube-config"
description: |-
...
```hcl
data "vcfa_kube_config" "kube_config" {}

data "vcfa_kube_config" "kube_config_supervisor_namespace" {
