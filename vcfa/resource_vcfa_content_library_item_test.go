		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(cli1, "status"),
					...
					resource.TestCheckResourceAttrSet(cli2, "status"),
					...
					resource.TestCheckResourceAttrSet(cli3, "status"),
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(cli4, "status"),
					...
					resource.TestCheckResourceAttrSet(cli5, "status"),
					...
					resource.TestCheckResourceAttrSet(cli6, "status"),
